...
namespace PaySplit.Droid
{
    class ListViewAdapter : BaseAdapter<string>
    {
        ...
        public ListViewAdapter(Context context, List<Bill> bills)
        {
            this.bills = bills;
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            TextView billName = rowView.FindViewById<TextView>(Resource.Id.View_BillEntry);
            billName.Text = bills[position].Name;
            billName.Click += delegate
            {
